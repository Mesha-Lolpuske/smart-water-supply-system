...
import { njoroAreas } from '../../utils/njoroData' // ADDED THIS IMPORT
...
function EditAnnouncement() {
  ...
  const [formData, setFormData] = useState({
    ...
    category: 'general',
    priority: 'normal',
    supplyArea: 'All Areas', // ADDED THIS
    expiryDate: '', // ADDED THIS
    isActive: true
  })
    ...
    const fetchAnnouncement = async () => {
      try {
        ...
        if (res.success) {
          ...
          // FIXED: Format the date properly for the input field
          setFormData({
            ...ann,
