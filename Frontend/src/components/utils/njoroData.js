...
export const njoroAreas = [
  {
    ...
    {
    id: 2, name: 'Egerton University Area', region: 'Njoro Sub-County', status: 'good',
    ...
    {
    id: 4, name: 'Lare Ward', region: 'Njoro Sub-County', status: 'good',
    ...
    {
    id: 5, name: 'Nesuit', region: 'Njoro Sub-County', status: 'good',
